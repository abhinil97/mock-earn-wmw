...
export function SupplyModal({ 
  ...
  // Fetch token balance for the selected asset
  ...
  console.log('tokenBalance HERE', tokenBalance)
  const balance = tokenBalance?.formatted ?? 0
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('amountNum TO Supply', amountNum)
        ...
        <div className="flex justify-between items-start mb-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              APY: <span className="text-green-600 font-medium">{market.supplyAPY.toFixed(2)}%</span>
            </p>
          </div>
          <button
            onClick={handleClose}
